...
public class SeanceModifyServlet extends HttpServlet {
    ...
    // modification séance après formulaire
        ...
        if (heureDebut == null || heureDebut.isBlank() || heureDebut.isEmpty() || heureFin == null || heureFin.isBlank() || heureFin.isEmpty()) {
            ...
            this.getServletContext().getRequestDispatcher("/modifySeance.jsp").forward(request, response);
        }
        ...
        if(LT_heureDebut.isAfter(LT_heureFin) || LT_heureDebut.equals(LT_heureFin)){
            ...
            seance_to_modify.horaireDebut = LT_heureDebut;
            seance_to_modify.horaireFin = LT_heureFin;
            ...
            String validation_message_seance_modify = "La séance datant du " + seance_to_modify.date + " a bien été modifié";
